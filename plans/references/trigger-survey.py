...
T3 = [
    ...
    ("... the spell it was: kicked or bargained -- an additional cost", "400.7d / 702.33d",
     ...
     "engine: `CastFacts.additional_costs_paid` (item 30, 2026-09-23); `Condition::SpellWasKicked` reads it, off the permanent or the resolving spell; no bargain leaf yet",
     ""),
    ("... the spell it was: an alternative cost -- prowl, surge, spectacle, madness, emerge, sneak", "400.7d / 118.9",
     TRIGGER + ' o:"cost was paid"', ["cast"],
     "engine: `CastFacts.alternative_cost` (item 30, 2026-09-23); no `Condition` leaf yet",
     ""),

...
| Ticket | Cards Unlocked | Example Cards | Status |
|---|---|---|---|
| RS-0 | **No cards.** Lifts the ten methods `ContinuousEffectRegistry` and `ReplacementEffectRegistry` already duplicate into one shared duration registry, so RS-1 uses it rather than inventing a third | — | 📋 designed 2026-08-27 (§9 finding 7) |

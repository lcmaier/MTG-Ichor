...
5. ~~**H1, H3–H6** — the latent code fixes~~ ✅ 2026-08-30, branch
   ...
   `0bce8b6`. Theme H now has no `fix` row left; H7–H9 are `defer`/`design`.

...
5. ~~**H1, H3–H6** — the latent code fixes~~ ✅ 2026-08-30, branch
   ...
   APNAP does not reach the CR 704.6d offers — found while answering an owner
   question about H4 and deliberately not taken with it.
...
remain, and are `defer`/`design`. **H10 is new** — found while answering an
owner question about H4, and the one live `fix` left in this theme. Note the
line numbers in the rows below predate 2026-08-30's renames and the H1/H4
fixes; they have drifted.

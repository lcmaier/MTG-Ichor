...
| A6b | **TR-2b**, whose first commit folds the "your" conditions into one variant with `whose: PlayerSet` | `triggers-architecture.md` §12, re-counted 2026-09-24; it builds the complete `Primitive::Sacrifice` and the wider `EventKindMask` every later phase reads | 1 |

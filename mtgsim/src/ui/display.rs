...
mod tests {
    ...
    fn test_format_stack_single_item_marker() {
        ...
        game.stack_entries.insert(bolt_id, StackEntry {
            ...
            x_value: None,
            effect: Effect::Atom(Primitive::DealDamage { amount: AmountExpr::Fixed(3), unpreventable: false }, EffectRecipient::Target(SelectionFilter::Any, TargetCount::Exactly(1))),
            is_spell: true,

...
/// `EnterWith` (`pipeline::ordering_cannot_change_the_outcome`): Root Maze beside
...
/// `ordering_cannot_change_the_outcome` must refuse to suppress.
///
...
/// is dynamic, which is what makes `ordering_cannot_change_the_outcome`'s new premise
...
///
/// 1. **It breaks `ordering_cannot_change_the_outcome`'s last premise for the most

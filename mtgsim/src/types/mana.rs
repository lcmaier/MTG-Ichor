...
pub enum ManaGrant {
    ...
    GrantKeyword(crate::types::keywords::KeywordFlag),
...
mod tests {
    ...
    fn test_special_no_coalesce_different_grants() {
        ...
        pool.add_special(ManaAtom {
            ...
            source_id: None,
            restrictions: vec![ManaRestriction::OnlyForSpellTypes(vec![CardType::Creature])],
            grants: vec![ManaGrant::GrantKeyword(crate::types::keywords::KeywordFlag::Haste)],
            persistence: ManaPersistence::Normal,
        });
    ...
    fn test_pay_with_plan_collects_grants() {
        ...
        assert_eq!(
            grants[0],
            ManaGrant::GrantKeyword(crate::types::keywords::KeywordFlag::Haste)
        );

...
fn test_two_entry_replacements_accumulate() {
    ...
    // `pipeline::ordering_cannot_change_the_outcome` says so. A provider with nothing
...
/// output. RC-4 turned that theorem into `pipeline::ordering_cannot_change_the_outcome`,
